...
This site is based from the [Long Haul](https://github.com/brianmaierjr/long-haul) template by [@brianmaierjr](https://twitter.com/brianmaierjr).  Follow the link to find the base version.

## License

This is [MIT](LICENSE), same as the base template.
>>>>>>> d9096d0 (Initial commit)
